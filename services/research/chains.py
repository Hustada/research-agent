    ...
    def __init__(self, llm: OpenAI):
        ...
        self.detailed_synthesis_prompt = PromptTemplate(
            ...
            template=(
                ...
                "Your answer should include an overview in one or two paragraphs, followed by bullet-pointed key findings, "
                "and highlight any contradictions between sources. "
                "Ensure your response is structured in clear paragraphs. "
                "If necessary, include novel examples of the topic to enhance understanding. "
                "Use inline citations (e.g., [Source 2])."
            )
        )
